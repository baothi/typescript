...
class Employee1 extends Person3 {
    ...
    //overwrite
    describe(): string {
        return `${super.describe()} from parent - describe `;
    }
}
...
let employee = new Employee1('Học TypeScrip', 'Bao THi', 'Web Developer');
...
let person2 = new Person2(25, 'Học TypeScrip', 'Bao THI');
...
let hoidanit = new Person("123", "Học TypeScrip", " Bao THi");
...
// console.log(">>> check add new: ", addNew(6, 9), addNew(" Hoc TypeScrip", " & Thi"))
...
console.log(Greet("Xin chao", "Bao Thi &", "Học Typescrip")); // returns "Hello Steve, Bill!"
